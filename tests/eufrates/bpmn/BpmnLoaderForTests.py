...
from eufrates.bpmn.specs.SubWorkflowTask import CallActivity, TransactionSubprocess
from eufrates.bpmn.specs.EndEvent import EndEvent
from eufrates.bpmn.specs.ExclusiveGateway import ExclusiveGateway
from eufrates.bpmn.specs.UserTask import UserTask
from eufrates.bpmn.parser.BpmnParser import BpmnParser
from eufrates.bpmn.parser.task_parsers import UserTaskParser, EndEventParser, CallActivityParser, TransactionSubprocessParser
from eufrates.bpmn.parser.util import full_tag
from eufrates.operators import Assign
