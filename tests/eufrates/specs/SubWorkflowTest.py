...
from eufrates.specs import WorkflowSpec, Simple, Join
from eufrates.specs.SubWorkflow import SubWorkflow
from eufrates.serializer.prettyxml import XmlSerializer
from eufrates.task import Task
from eufrates.workflow import Workflow
...
class TaskSpecTest(unittest.TestCase):
    ...
    def load_workflow_spec(self, folder, f):
        file = os.path.join(
            os.path.dirname(__file__), '..', 'data', 'eufrates', folder, f)
