...
from eufrates.specs import Celery, WorkflowSpec
from eufrates.operators import Attrib
from eufrates.serializer.dict import DictionarySerializer
...
class CeleryTest(TaskSpecTest):
    ...
    def testSerializationWithoutKwargs(self):
        ...
        data = {'inputs': ['Wait:1'], 'lookahead': 2, 'description': '',
                ...
                'class': 'eufrates.specs.Celery.Celery',
                'name': 'RS1:1'}
