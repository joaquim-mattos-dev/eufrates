...
from eufrates.camunda.parser.UserTaskParser import UserTaskParser
from eufrates.camunda.specs.UserTask import UserTask
from eufrates.camunda.parser.CamundaParser import CamundaParser
